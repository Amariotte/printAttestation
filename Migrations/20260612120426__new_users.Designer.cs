...
namespace print_attestation.Migrations
{
    ...
    [Migration("20260612120426__new_users")]
    partial class _new_users
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ask.Model.t_refresh_token", b =>
                {
                    ...
                    b.Property<int?>("t_usersr_id")
                        .HasColumnType("int");

                    b.HasKey("r_id");

                    b.HasIndex("t_usersr_id");
            ...
            modelBuilder.Entity("ask.Model.t_users", b =>
                {
                    b.Property<int>("r_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex(new[] { "r_telephone" }, "IX_User_Telephone")
                        .HasDatabaseName("IX_User_Telephone1");
            ...
            modelBuilder.Entity("ask.Model.t_refresh_token", b =>
                {
                    ...
                    b.HasOne("ask.Model.t_users", null)
                        .WithMany("r_refresh_tokens")
                        .HasForeignKey("t_usersr_id");
